...
import rtx from "../../imageLinks/rtx-logo.png"
import diamond from "../../imageLinks/croppedDiamond.jpg";
  ...
  return (
    <div className="experience" ref={ref} style={experienceStyle}>
        <div className="circle">
            <img src={rtx} alt="Raytheon Logo" className='rtxLogo'/>
        </div>
        ...
        <div className='bulletPoints' style={bulletPointStyle}>
            <div className='firstBulletPoint'>
                <img src={diamond} alt="Diamond bullet point" className='diamond' style={diamondStyle}/>
