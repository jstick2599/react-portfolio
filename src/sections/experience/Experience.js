  ...
  return (
    <div className="experience" ref={ref} style={experienceStyle}>
        <div className="circle">
            <img src="../../../public/imageLinks/rtx-logo.png" alt="Raytheon Logo" className='rtxLogo'/>
        </div>
        ...
        <div className='bulletPoints' style={bulletPointStyle}>
            <div className='firstBulletPoint'>
                <img src="../../../public/imageLinks/croppedDiamond.jpg" alt="Diamond bullet point" className='diamond' style={diamondStyle}/>
